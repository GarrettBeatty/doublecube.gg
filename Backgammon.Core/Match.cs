...
namespace Backgammon.Core
{
    public class Match
    {
        ...
        public Match(string matchId, string player1Id, string player2Id, int targetScore) : this()
        {
            MatchId = matchId;
            Player1Id = player1Id;
            Player2Id = player2Id;
        ...
        {
            if (Player1Score >= TargetScore) return Player1Id;
            if (Player2Score >= TargetScore) return Player2Id;
            return null;
        }
